...
async def spam_function(event, jepthon, jmthon, sleeptimem, sleeptimet, DelaySpam=False):
...
async def spammer(event):
    ...
    await spam_function(event, jepthon, jmthon, sleeptimem, sleeptimet)


@jmthon.ar_cmd(pattern=f"مكرر (.*)")
async def spammer(event):
